...
<methodCall>
  ...
  <params>
    ...
    const createRes = await fetch(object, {
      method: "POST",
      headers: { "Content-Type": "text/xml" },
      body: `<?xml version="1.0"?><methodCall><methodName>execute_kw</methodName><params><param><value><string>${odooDb}</string></value></param><param><value><int>${uid}</int></value></param><param><value><string>${odooApiKey}</string></value></param><param><value><string>crm.lead</string></value></param><param><value><string>create</string></value></param><param><value><array><data><value><struct><member><name>name</name><value><string>${leadName}</string></value></member><member><name>contact_name</name><value><string>${contactName}</string></value></member><member><name>email_from</name><value><string>${email}</string></value></member><member><name>partner_name</name><value><string>${empresa}</string></value></member><member><name>stage_id</name><value><int>1</int></value></member><member><name>x_qubra_score</name><value><double>${data.scores.global}</double></value></member><member><name>type</name><value><string>opportunity</string></value></member><member><name>description</name><value><string>${descEscaped}</string></value></member></struct></value></data></array></value></param></params></methodCall>`,
    });
